...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _scripts_Products__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./scripts/Products */ \"./src/scripts/Products.js\");\n/* harmony import */ var _scripts_catalog__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./scripts/catalog */ \"./src/scripts/catalog.js\");\n/* harmony import */ var _scripts_main__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./scripts/main */ \"./src/scripts/main.js\");\n/* harmony import */ var _styles_Products_css__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./styles/Products.css */ \"./src/styles/Products.css\");\n\r\n\r\n\r\n\r\nvar productsPage = new _scripts_Products__WEBPACK_IMPORTED_MODULE_0__.Products();\r\nproductsPage.render();\r\nfor(let i = 0;i<_scripts_catalog__WEBPACK_IMPORTED_MODULE_1__.CATALOG.length;i++)\r\n{\r\n    var element = document.getElementById(_scripts_catalog__WEBPACK_IMPORTED_MODULE_1__.CATALOG[i].id);\r\n    element.addEventListener('click',(0,_scripts_main__WEBPACK_IMPORTED_MODULE_2__.SetClick)(element,_scripts_catalog__WEBPACK_IMPORTED_MODULE_1__.CATALOG[i].id));\r\n}\r\n\r\n\r\n\r\n\n\n//# sourceURL=webpack://c/./src/index.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"SetClick\": () => (/* binding */ SetClick)\n/* harmony export */ });\n/* harmony import */ var _localStorageUtils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./localStorageUtils */ \"./src/scripts/localStorageUtils.js\");\n\r\nfunction SetClick(element,id) {\r\n    const { pushProduct, products } = _localStorageUtils__WEBPACK_IMPORTED_MODULE_0__.localStorageUtil.putProducts(id);\r\n    \r\n    if (pushProduct) {\r\n        element.classList.add('products-element__btn_active');\r\n        element.innerHTML = 'Удалить из корзины';\r\n    } else {\r\n        element.classList.remove('products-element__btn_active');\r\n        element.innerHTML = 'Добавить в корзину';\r\n    }\r\n}\n\n//# sourceURL=webpack://c/./src/scripts/main.js?");
